        ...
        <header className="app-header">
            <nav className="navbar navbar-expand-lg navbar-light">
                ...
                <div className="" style={{ width: "100%", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                    <div style={{ overflow: "hidden", whiteSpace: "nowrap", width: "80%" }} id="scroll-container">
                        <div id="scroll-text">
                        Disclaimer: Kindly Check the Applicable Compliance with an Expert. Interpretations may Vary. | REFRESH - My Compliances / All Compliances to view Updated Records.
                        </div>
                    </div>
